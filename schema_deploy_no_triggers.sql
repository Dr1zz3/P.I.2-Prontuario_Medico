...
-- ==============================================================
-- TRIGGERS REMOVIDOS PARA HOSPEDAGENS COMPARTILHADAS
-- (InfinityFree, 000webhost, etc. não concedem privilégio TRIGGER)
--
-- A imutabilidade (RASCUNHO → ASSINADO → SUSPENSO) é garantida na
-- camada PHP — veja evolucoes.php, sinais_vitais.php, receitas.php.
-- Em XAMPP local ou hospedagens privilegiadas, use schema.sql.
-- ==============================================================
